...
@overload
def simulate(
    variogram: Variogram, nx: int, ny: int, nz: int, dx: float, dy: float, dz: float
...
@overload
def simulate(
    variogram: Variogram, nx: int, dx: float, ny: int, dy: float, nz: int, dz: float
) -> npt.NDArray[np.float64]: ...
@overload
def simulate(
    variogram: Variogram, nx: int, dx: float, ny: int, dy: float
) -> npt.NDArray[np.float64]: ...
@overload
def simulate(variogram: Variogram, nx: int, dx: float) -> npt.NDArray[np.float64]: ...
@overload
...
@overload
def simulation_size(variogram: Variogram, nx: int, dx: float) -> tuple[int]: ...
def quote() -> str: ...
