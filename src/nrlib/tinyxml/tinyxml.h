...
class TiXmlNode : public TiXmlBase {
  ...
  */
  ...
  const TiXmlNode* FirstChild(const char* value) const;  ///< The first child of this node with the matching 'value'.
                                                         ///< Will be null if none found.
  const TiXmlNode* FirstChild(const char* value, int& index) const;  ///< The first child of this node with the
                                                                     ///< matching 'value'. Will be null if none found.
  ...
  const TiXmlNode* LastChild(const char* value) const;  /// The last child of this node matching 'value'. Will be null
  ...
  */
  ...
  /// Convenience function to get through elements.
  const TiXmlElement* FirstChildElement(const char* _value, int& index) const;
  TiXmlElement*       FirstChildElement(const char* _value, int& index) {
    return const_cast<TiXmlElement*>((const_cast<const TiXmlNode*>(this))->FirstChildElement(_value, index));
  }
...
std::string" but template specialization is hard to get working cross-compiler.
...
class TiXmlDocument : public TiXmlNode {
  ...
  */
  ...
  /** Load a file using the given FILE*. Returns true if successful. Note that
     this method doesn't stream - the entire object pointed at by the FILE* will
     be interpreted as an XML file. TinyXML doesn't stream in XML from the
     current file location. Streaming may be added in the future.
  */
  ...
  */
  ...
  /* Write the document to a string using formatted printing ("pretty print").
     ...
     pointer. The calling code pust call delete[] on the return char* to avoid a
     memory leak.
  */
...
class TiXmlPrinter : public TiXmlVisitor {
  ...
  */
  ...
  /** Switch over to "stream printing" which is the most dense formatting
     without linebreaks. Common when the XML is needed for network transmission.
  */
