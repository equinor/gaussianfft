...
class TrendConstantStorage : public TrendStorage {
 public:
  TrendConstantStorage(const double& value, const bool& estimate);
...
class Trend1DStorage : public TrendStorage {
 public:
  Trend1DStorage(const std::string& file_name, const std::string& reference_parameter, const bool& estimate);
