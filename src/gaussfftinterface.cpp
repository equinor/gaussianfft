...
PYBIND11_MODULE(_gaussianfft, m, py::mod_gil_not_used(), py::multiple_interpreters::per_interpreter_gil()) {
  ...
  // Padding
  //
  m.def("simulation_size", &GaussFFT::FindGridSizeAfterPadding, py::arg("variogram"), py::arg("nx"), py::arg("dx"),
        py::arg("ny") = 1U, py::arg("dy") = -1.0, py::arg("nz") = 1U, py::arg("dz") = -1.0, padding_docstring.c_str());

  //
  // Variogram factory function
  //
  m.def("variogram", &GaussFFT::CreateVariogram, py::arg("type"), py::arg("main_range"), py::arg("perp_range") = -1.0,
        py::arg("depth_range") = -1.0, py::arg("azimuth") = 0.0, py::arg("dip") = 0.0,
        // py::arg("sd")=1.0,
        py::arg("power") = 1.5, py::return_value_policy::take_ownership, variogram_docstring.c_str());

  // Simulate core function
  //
  m.def("simulate", &GaussFFT::Simulate, py::arg("variogram"), py::arg("nx"), py::arg("dx"), py::arg("ny") = 1U,
        py::arg("dy") = -1.0, py::arg("nz") = 1U, py::arg("dz") = -1.0, simulate_docstring.c_str());
  ...
  // Simulate core function
  //
  advanced.def("simulate", &GaussFFT::SimulateWithAdvancedSettings, py::arg("variogram"), py::arg("nx"), py::arg("dx"),
               py::arg("ny") = 1U, py::arg("dy") = -1.0, py::arg("nz") = 1U, py::arg("dz") = -1.0,
               py::arg("padx") = -1, py::arg("pady") = -1, py::arg("padz") = -1, py::arg("sx") = 1.0,
               py::arg("sy") = 1.0, py::arg("sz") = 1.0, advanced_simulate_docstring.c_str());
}
